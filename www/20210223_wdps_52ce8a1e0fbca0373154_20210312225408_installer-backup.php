...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210223_wdps_52ce8a1e0fbca0373154_20210312225408_archive.zip';
	const ARCHIVE_SIZE		 = '34251768';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '52ce8a1-12225408';
    const SECONDARY_PACKAGE_HASH = 'e80cbe1-12225408';
	const VERSION			 = '1.4.0';
