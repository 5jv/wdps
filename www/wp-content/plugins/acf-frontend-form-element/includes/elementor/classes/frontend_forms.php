        ...
        public function get_form_data( $form_args )
        {
            ...
            switch ( $form_args['hidden_fields']['main_action'] ) {
                ...
                case 'duplicate_post':
                    ...
                    if ( $form_args['post_to_duplicate'] == 'current_post' ) {
                        $form_args['post_id'] = $post->ID;
                    } elseif ( $form_args['post_to_duplicate'] == 'select_post' ) {
                        $form_args['post_id'] = $form_args['post_select'];
                    } elseif ( $form_args['post_to_duplicate'] == 'url_query' && isset( $_GET[$form_args['url_query_post']] ) ) {
                        $form_args['post_id'] = $_GET[$form_args['url_query_post']];
                        $form_args['url_query'] = $form_args['url_query_post'];
                    }
                ...
                case 'new_term':
                    ...
                    $args = [
                        'taxonomy' => $form_args['new_term_taxonomy'],
                    ];
                    $action = 'term';
                    break;
                case 'edit_term':
